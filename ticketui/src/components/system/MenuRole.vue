<template>
  <div>
    <div style="text-align: left;" v-loading="loading">
      ...
      <el-button type="primary" size="mini" style="margin-left: 5px;background-color:#3771de;border-color:#3771de;" @click="addNewRole">添加角色</el-button>
    </div>
    <div style="margin-top: 10px;text-align: left">
      <el-collapse v-model="activeColItem" accordion style="width: 100%;" @change="collapseChange">
        <el-collapse-item v-for="(item,index) in roles" :title="item.nameZh" :name="item.id" :key="item.name">
          <el-card class="box-card">
            ...
            <div class="menuButton">
              ...
              <el-button type="primary" size="mini" style="background-color:#3771de;border-color:#3771de;" @click="updateRoleMenu(index)">确认修改</el-button>
            </div>
          </el-card>
        </el-collapse-item>
      </el-collapse>
...
<style scoped>
  ...
  .menuButton >>> .el-button--primary:focus, .el-button--primary:hover {
    color: #409EFF;
  }

  @media screen and (max-width:1366px){.myInput{width: 45%;}}/*宽度小于1360px时 */
  @media screen and (min-width:1366px){.myInput{width: 50%;}}/*宽度大于1360px时 */
</style>
