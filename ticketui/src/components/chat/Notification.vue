      ...
      <el-main style="padding: 0px;">
        <el-collapse accordion style="width: 90%" @change="handleChange" v-model="mid">
          <el-collapse-item v-for="(msg,index) in sysmsgs" :key="index" :name="msg.msgContent.id">
            ...
            <div
              style="display: flex;justify-content: flex-start;align-items: center;border-style: solid;border-width: 1px;border-color: #409eff;border-radius: 4px;padding: 4px 0px 4px 8px;box-sizing: border-box;height: 100%">
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        <el-row style="margin-top: 10px;padding-right: 10px">
          <el-col :offset="18">
            <el-button style="font-size: 14px;" type="default" size="mini" @click="cancelSend">取消
            </el-button>
            <el-button class="myButtonQ" type="primary" size="mini" @click="sendNFMsg"><i
              class="fa fa-send"
